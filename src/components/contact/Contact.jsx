...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      ...
      .then(
        (result) => {
          alert("You email was sent successfully.");
        },
        (error) => {
          alert(
            "Some thing went wrong. Couldn't send your email. Please try again later."
          );
        }
      );
  };
